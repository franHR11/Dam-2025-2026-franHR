...
clientes = [{
    ...
    "edad": 35,
    "emails": [
        {"tipo": "personal", "direccion": "antonio.garcia@email.com"},
        {"tipo": "empresa", "direcciones": ["a.garcia@empresa.es"]}
    ]
}, {
    "nombre": "María",
    ...
    "edad": 28,
    "emails": [
        {"tipo": "personal", "direccion": "maria.lopez@email.com"},
        {"tipo": "empresa", "direcciones": ["m.lopez@empresa.es"]}
    ]
}]
