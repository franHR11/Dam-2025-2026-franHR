...
if not galeria_files:
    print(f"Advertencia: No se encontraron imágenes en '{GALERIA_FOLDER}'. Se generarán solo fondos de color.")
    ...
    try:
        ...
        if LOGO_FILENAME and os.path.exists(LOGO_FILENAME):
            ...
            background.paste(logo, (pos_x, pos_y), logo)
             ...
             print(f"Advertencia: El logo '{LOGO_FILENAME}' no se encuentra.")
